...
# 短信模板 CODE（阿里云赠送模板，只填精确 CODE，勿带描述文字）：
#   100001 登录/注册 · 100004 绑定新手机号 · 100005 验证绑定手机号
export CC_SMS_TEMPLATE_LOGIN_REGISTER_CODE='100001'
export CC_SMS_TEMPLATE_BIND_NEW_CODE='100004'
export CC_SMS_TEMPLATE_VERIFY_BOUND_CODE='100005'
```
