...
/**
 * 关于我们纯展示视图（/about，未登录可看，SSR 安全）：Chat Circles 项目完整介绍。
...
const ACTIVITY_FLOW = [
  { time: '开场', name: '正念安定', desc: '在引导下做简短的正念练习，让身心先慢下来。' },
  {
    time: '60 分钟',
    name: '一对一对话',
    desc: '活动的核心：由提示卡引导、以正向心理学为框架的结构化对话。',
  },
...
export function AboutPageView({ actions }: { actions?: ReactNode }) {
  return (
    <PublicPageLayout actions={actions}>
      ...
      <section aria-labelledby="about-who" className="ccp-about-section">
        ...
        <p className="ccp-about-text">
          Chat Circles 是由社会企业 Empact 发起的青年心理健康公益项目。我们把经过 3
          小时专业培训的志愿者（「倾听者」），与处于升学、初入职场等过渡期的青年（「倾诉者」）一对一配对，在一个安全、温暖、刻意非临床的空间里，进行
        ...
        <div className="ccp-card-grid">
          <div className="ccp-card">
            <div className="ccp-card-body">
              ...
              <NavAnchor href="/activities" className="cc-btn cc-btn-primary cc-btn-block">
                浏览活动并报名
              </NavAnchor>
            </div>
          </div>
          <div className="ccp-card">
            <div className="ccp-card-body">
              ...
              <NavAnchor href="/activities" className="cc-btn cc-btn-secondary cc-btn-block">
                查看培训与活动
              </NavAnchor>
            </div>
          </div>
      ...
      <section aria-labelledby="about-support" className="ccp-about-section">
        ...
        <p className="ccp-about-text">
          Chat Circles
          模式轻量、可复制。如果你是基金会、企业或社区伙伴，可以通过以下任意一种方式参与：
        </p>
